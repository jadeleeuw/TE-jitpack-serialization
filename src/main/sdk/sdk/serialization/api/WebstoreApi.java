...
import sdk.serialization.model.OrderRequest;
...
public class WebstoreApi {
     ...
     * <p><b>200</b> - The order request that needs to be assembled for assignment B.
     * @return OrderRequest
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Mono<OrderRequest> getOrderRequest() throws HttpClientErrorException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/webstore/orders/requests/assignment_b").build().toUriString();
        ...
        ParameterizedTypeReference<OrderRequest> returnType = new ParameterizedTypeReference<OrderRequest>() {};
        return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
}
